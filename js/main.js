...
$(document).ready(function() {
	...
	d3.select('.header-logo')
		.on('mouseover', function() { d3.selectAll('.header-logo circle').style('fill', function(d) {return d.hover;}) })
...
function createLogo(selector)  {
	...
	var 	nodes = [
		{name: "red", color: GREY, hover: BLUE},
		{name: "orange",  color: GREY, hover: ORANGE},
		{name: "blue", color: GREY, hover: RED},
		{name: "green", color: GREY, hover: GREEN},
	];
