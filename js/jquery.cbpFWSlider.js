	...
	$.CBPFWSlider.prototype = {
		...
		_config : function() {
			...
			if( this.itemsCount > 1 ) {
				...
				this.$navPrev = $( '<span class="cbp-fwprev">&lsaquo;</span>' ).addClass('grey');
		...
		_toggleNavControls : function() {
			...
			switch( this.current ) {
				...
				case 0 : this.$navNext.removeClass('grey'); this.$navPrev.addClass('grey'); break;
				case this.itemsCount - 1 : this.$navNext.addClass('grey'); this.$navPrev.removeClass('grey');; break;
				default : this.$navNext.removeClass('grey');; this.$navPrev.removeClass('grey'); break;
			}
